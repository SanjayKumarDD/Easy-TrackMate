(function () {
  ...
  var u,
    ...
    Ya,
    ib = y.documentElement.ontouchstart !== u,
    Jb = {},
    ub = 0,
    bb,
    G,
  ...
  G = {
    ...
    global: {
      useUTC: !0,
      canvasToolsURL:
        "http://code.highcharts.com/3.0.9/modules/canvas-tools.js",
      VMLRadialGradientURL:
        "http://code.highcharts.com/3.0.9/gfx/vml-radial-gradient.png",
    },
    chart: {
      borderColor: "#4572A7",
      borderRadius: 5,
    ...
    ta = function (a) {
      ...
      (function (a) {
        a && a.stops
          ...
          : (c = Ub.exec(a)) && (b = [z(c[1]), z(c[2]), z(c[3]), 1]);
      })(a);
      return {
        get: function (c) {
          var f;
  ...
  pa.prototype = {
          ...
          if (
            ...
            if (c === "d")
              ...
              (e = g.getElementsByTagName("title")[0]),
                e || ((e = y.createElementNS(Ca, "title")), g.appendChild(e)),
                (e.textContent = d);
            c === "strokeWidth" && (c = "stroke-width");
    ...
    clip: function (a) {
      return this.attr(
        "clip-path",
        a ? "url(" + this.renderer.url + "#" + a.id + ")" : Q
      );
    },
    ...
    css: function (a) {
      var b = this.element,
        c = (this.textWidth =
          a && a.width && b.nodeName.toLowerCase() === "text" && z(a.width)),
        d,
        e = "",
        f = function (a, b) {
    ...
    getBBox: function () {
      ...
      var h;
      if (d === "" || Ob.test(d))
        (h = d.length + "|" + f.fontSize + "|" + f.fontFamily),
          (a = b.cache[h]);
      if (!a) {
        ...
        if (b.isSVG) {
          ...
          if (ya && f && f.fontSize === "11px" && d.toPrecision(3) === "16.9")
            a.height = d = 14;
          if (e)
            (a.width = M(d * ba(g)) + M(c * U(g))),
              (a.height = M(d * U(g)) + M(c * ba(g)));
        }
        this.bBox = a;
        h && (b.cache[h] = a);
      }
  ...
  ua.prototype = {
    ...
    init: function (a, b, c, d) {
      ...
      this.alignedObjects = [];
      this.url =
        (Xa || hb) && y.getElementsByTagName("base").length
          ? e.href
              .replace(/#.*?$/, "")
              .replace(/([\('\)])/g, "\\$1")
              .replace(/ /g, "%20")
      ...
      this.createElement("desc")
        .add()
        .element.appendChild(y.createTextNode("Created with Highcharts 3.0.9"));
        ...
        p(l, function (e) {
          if (e !== "" || l.length === 1) {
            var o = {},
              ...
              p;
            g.test(e) &&
              ((p = e.match(g)[1].replace(/(;| |^)color([ :])/, "$1fill$2")),
              v(n, "style", p));
            h.test(e) &&
              !d &&
            ...
            if (
              ...
              !m &&
                f &&
                (!V && d && D(n, { display: "block" }),
                v(n, "dy", q(n), hb && n.offsetHeight)),
              b.appendChild(n),
              m++,
              k)
            )
              for (
                var e = e.replace(/([^\^])-/g, "$1- ").split(" "),
                  o = e.length > 1 && j.whiteSpace !== "nowrap",
                  t,
                  s,
                  w = a._clipHeight,
                  u = [],
                ...
                delete a.bBox,
                  ...
                  !V &&
                    c.forExport &&
                    (s = c.measureSpanWidth(n.firstChild.data, a.styles)),
                  (t = s > k),
                  !t || e.length === 1
                    ? ((e = u),
                      (u = []),
    ...
    setSize: function (a, b, c) {
      ...
      this.height = b;
      for (
        this.boxWrapper[n(c, !0) ? "animate" : "attr"]({ width: a, height: b });
        e--;
      ...
      if (g) {
        ...
        h[q]
          ...
          : ((c.id = a = "highcharts-" + ub++),
            (h[q] = i = d.createElement(g).attr(c).add(d.defs)),
            (i.stops = []),
            p(j, function (a) {
              f.test(a[1])
                ? ((e = ta(a[1])), (k = e.get("rgb")), (l = e.get("a")))
                : ((k = a[1]), (l = 1));
              a = d
                .createElement("stop")
        ...
        return f.test(a)
          ? ((e = ta(a)), v(b, c + "-opacity", e.get("a")), e.get("rgb"))
    ...
    label: function (a, b, c, d, e, f, g, h, i) {
      function j() {
        ...
        a = n.element.style;
        va =
          (Z === void 0 || Sa === void 0 || o.styles.textAlign) && n.getBBox();
        ...
        if (y) {
          if (!H)
            (a = w(-s * ea)),
              ...
              (o.box = H =
                d
                  ? q.symbol(d, a, b, o.width, o.height, v)
                  : q.rect(a, b, o.width, o.height, 0, v[Lb])),
              H.add(o);
        ...
        if (b.tagName === "SPAN") {
          ...
          if (m !== this.cTT) {
            ...
            if (i > l && /[ \-]/.test(b.textContent || b.innerText))
              D(b, { width: l + "px", display: "block", whiteSpace: "normal" }),
                (i = l);
          ...
          for (c in a)
            if (
              ...
              if (
                ...
                (this[c] = f.style[c] = d),
                  (f.style.left = -w(ba(d * Ba) + 1) + "px"),
                  (f.style.top = w(U(d * Ba)) + "px");
              else if (
                c === "translateX" ||
                c === "translateY" ||
                c === "rotation"
    ...
    var xb = {
      ...
      color: function (a, b, c, d) {
        ...
        if (i) {
          ...
          p(a, function (a, b) {
            g.test(a[1])
              ? ((f = ta(a[1])), (k = f.get("rgb")), (l = f.get("a")))
              : ((k = a[1]), (l = 1));
            w.push(a[0] * 100 + "% " + k);
            b ? ((n = l), (H = k)) : ((o = l), (s = k));
          });
      ...
      symbols: {
        ...
        rect: function (a, b, c, d, e) {
          var f = a + c,
            ...
            h;
          !t(e) || !e.r
            ? (f = ua.prototype.symbols.square.apply(0, arguments))
            : ((h = I(e.r, c, d)),
              (f = [
                "M",
                a + h,
  ...
  Qa.prototype = {
    ...
    handleOverflow: function (a, b) {
      ...
      if (n)
        (B =
          (d = d.ticks[i[a + (e ? 1 : -1)]]) &&
          d.label.xy &&
          d.label.xy.x + d.getLabelSides()[e ? 0 : 1]),
          (i = B),
          (e && !h) || (f && h)
            ? g + k < l && ((g = l - k), d && g + j > i && (c = !1))
            : g + j > m && ((g = m - j), d && g + k < i && (c = !1)),
          (b.x = g);
      return c;
    },
    ...
    render: function (a, b, c) {
      ...
      if (m && s)
        w === "inside" && (s = -s),
          d.opposite && (s = -s),
          (h = this.getMarkPath(y, v, s, m * B, g, f)),
          q
            ? q.animate({ d: h, opacity: c })
            : (this.mark = f
                .path(h)
                .attr({ stroke: t, "stroke-width": m, opacity: c })
                .add(d.axisGroup));
      if (i && !isNaN(y))
        (i.xy = v = this.getLabelPosition(y, v, i, g, k, x, a, r)),
          (this.isFirst && !this.isLast && !n(e.showFirstLabel, 1)) ||
          (this.isLast && !this.isFirst && !n(e.showLastLabel, 1))
            ? (Z = !1)
            : !d.isRadial &&
              !k.step &&
              !k.rotation &&
  ...
  yb.prototype = {
    render: function () {
      ...
      if (t(w)) d.zIndex = w;
      if (q)
        if (o) q.animate({ d: o }, null, q.onGetPath);
        else {
          if (
            (q.hide(),
  ...
  qa.prototype = {
    ...
    init: function (a, b) {
      ...
      this.crosshair = n(
        d.crosshair,
        ja(a.options.tooltip.crosshairs)[c ? 0 : 1],
        !1
      );
      var f,
        ...
        if (c.visible || !b.options.chart.ignoreHiddenSeries) {
          ...
          if (a.isXAxis) {
            if (((d = c.xData), d.length))
              (a.dataMin = I(n(a.dataMin, d[0]), La(d))),
                (a.dataMax = s(n(a.dataMax, d[0]), za(d)));
          } else {
            c.getExtremes();
            e = c.dataMax;
            c = c.dataMin;
            if (t(c) && t(e))
              (a.dataMin = I(n(a.dataMin, c), c)),
                (a.dataMax = s(n(a.dataMax, e), e));
            if (t(d))
    ...
    getLinearTickPositions: function (a, b, c) {
      for (
        var d, b = aa(N(b / a) * a), c = aa(Ha(c / a) * a), e = [];
        b <= c;
    ...
    setTickPositions: function (a) {
      ...
      h
        ? ((b.linkedParent = c[b.coll][d.linkedTo]),
          ...
          (b.min = n(c.min, c.dataMin)),
          (b.max = n(c.max, c.dataMax)),
          d.type !== b.linkedParent.options.type && ka(11, 1))
        : ((b.min = n(b.userMin, d.min, b.dataMin)),
          (b.max = n(b.userMax, d.max, b.dataMax)));
      if (e)
        !a && I(b.min, n(b.dataMin, b.min)) <= 0 && ka(10, 1),
          (b.min = aa(xa(b.min))),
          (b.max = aa(xa(b.max)));
      if (b.range && t(b.max))
      ...
      b.min === b.max || b.min === void 0 || b.max === void 0
        ? (b.tickInterval = 1)
        : h && !l && q === b.linkedParent.options.tickPixelInterval
        ? (b.tickInterval = b.linkedParent.tickInterval)
        : ((b.tickInterval = n(
            l,
            ma ? 1 : ((b.max - b.min) * q) / s(b.len, q)
          )),
          !t(l) &&
            b.len < q &&
            !this.isRadial &&
    ...
    zoom: function (a, b) {
      this.allowZoomOutside ||
        (t(this.dataMin) && a <= this.dataMin && (a = u),
        t(this.dataMax) && b >= this.dataMax && (b = u));
        ...
        if (a.horiz && !a.staggerLines && Z && !o.rotation) {
          for (v = a.reversed ? [].concat(e).reverse() : e; x < Z; ) {
            ...
            for (o = 0; o < v.length; o++)
              (z = v[o]),
                (K = (K = f[z].label && f[z].label.getBBox()) ? K.width : 0),
                (B = o % x),
                K &&
                  ((z = a.translate(z)),
                  j[B] !== u && z < j[B] && (y = !0),
    ...
    render: function () {
      var a = this,
        ...
        y,
        z = (a.justifyLabels =
          !a.staggerLines && b && f.labels.overflow === "justify"),
        K;
      ...
      if (v || h)
        if (
          ...
          i.length &&
            ((j = i.slice()),
            ((b && c) || (!b && !c)) && j.reverse(),
            z && (j = j.slice(1).concat([j[0]])),
            p(j, function (b, c) {
              z && (c = c === j.length - 1 ? 0 : c + 1);
              if (!h || (b >= a.min && b <= a.max))
                m[b] || (m[b] = new Qa(a, b)),
                  w && m[b].isNew && m[b].render(c, !0, 0.1),
                  m[b].render(c, !1, 1);
            }),
            s &&
              a.min === 0 &&
              (m[-1] || (m[-1] = new Qa(a, -1, null, !0)), m[-1].render(-1))),
          H &&
            p(i, function (b, c) {
              if (c % 2 === 0 && b < a.max)
                o[b] || (o[b] = new yb(a)),
                  (y = b + s),
                  (K = i[c + 1] !== u ? i[c + 1] + s : a.max),
                  (o[b].options = {
                    from: g ? ga(y) : y,
                    to: g ? ga(K) : K,
                    color: H,
      ...
      if (r)
        (b = a.getLinePath(r)),
          a.axisLine
            ...
            : (a.axisLine = e
                .path(b)
                .attr({ stroke: f.lineColor, "stroke-width": r, zIndex: 7 })
                .add(a.axisGroup)),
    ...
    drawCrosshair: function (a, b) {
      if (this.crosshair)
        if ((t(b) || !n(this.crosshair.snap, !0)) === !1) this.hideCrosshair();
          ...
          c = this.isRadial
            ? this.getPlotLinePath(this.isXAxis ? b.x : n(b.stackY, b.y))
  ...
  qa.prototype.getLogTickPositions = function (a, b, c, d) {
    ...
    if (a >= 0.5) (a = w(a)), (g = this.getLinearTickPositions(a, b, c));
      ...
      (a = nb(a, null, mb(a))),
      (g = Ra(this.getLinearTickPositions(a, b, c), xa)),
      !d)
    )
    ...
    if (t(b)) {
      ...
      for (
        var d = i.getTime(),
          l = i[db](),
          m = i[Wa](),
          q = g ? Pa : (864e5 + i.getTimezoneOffset() * 6e4) % 864e5;
        d < c;
  ...
  tb.prototype = {
    ...
    refresh: function (a, b) {
      ...
      i === !1
        ? this.hide()
        : (this.isHidden && (Za(d), d.attr("opacity", 1).show()),
          d.attr({ text: i }),
  ...
  $a.prototype = {
    ...
    runPointActions: function (a) {
      ...
      if (e && b.options.tooltip.shared && (!i || !i.noSharedTooltip)) {
        ...
        for (k = 0; k < j; k++)
          if (
            d[k].visible &&
            d[k].options.enableMouseTracking !== !1 &&
            !d[k].noSharedTooltip &&
            d[k].tooltipPoints.length &&
            (f = d[k].tooltipPoints[m]) &&
            f.series
          )
    ...
    pinchTranslateDirection: function (a, b, c, d, e, f, g, h) {
      ...
      b < t.min
        ? ((b = t.min), (y = !0))
        : b + o > t.max && ((b = t.max - o), (y = !0));
      y
        ? ((u -= 0.8 * (u - g[j][0])), r || (x -= 0.8 * (x - g[j][1])), c())
        : (g[j] = [u, x]);
      s || ((f[j] = n - q), (f[m] = o));
      f = s ? 1 / p : p;
      e[m] = o;
    ...
    drag: function (a) {
      ...
      if (this.hasDragged > 10) {
        ...
        this.selectionMarker &&
          f &&
          ((d -= m),
          this.selectionMarker.attr({ width: M(d), x: (d > 0 ? 0 : d) + m }));
        this.selectionMarker &&
          g &&
          ((d = e - q),
          this.selectionMarker.attr({ height: M(d), y: (d > 0 ? 0 : d) + q }));
        ...
        if (this.hasDragged || c)
          p(b.axes, function (a) {
            if (a.zoomEnabled) {
              ...
              !isNaN(c) &&
                !isNaN(b) &&
                (d[a.coll].push({ axis: a, min: I(c, b), max: s(c, b) }),
                (h = !0));
            }
          }),
            h &&
      ...
      if (!b.cancelClick)
        c && this.inClass(a.target, "highcharts-tracker")
          ? ((g = this.chartPosition),
            ...
            A(c.series, "click", r(a, { point: c })),
            b.hoverPoint && c.firePointEvent("click", a))
          : (r(a, this.getCoordinates(a)),
            b.isInsidePlot(a.chartX - d, a.chartY - e) && A(b, "click", a));
    },
  ...
  if (C.PointerEvent || C.MSPointerEvent) {
    ...
    Va($a.prototype, "init", function (a, b, c) {
      b.container.style["-ms-touch-action"] = b.container.style[
        "touch-action"
      ] = "none";
      a.call(this, b, c);
    });
    Va($a.prototype, "setDOMEvents", function (a) {
      ...
      p(
        ...
        function (a) {
          F(
            a[0],
            window.PointerEvent ? a[1].toLowerCase() : "MS" + a[1],
            function (d) {
              d = d.originalEvent;
              if (
                d.pointerType === "touch" ||
    ...
    renderItem: function (a) {
      ...
      if (
        ...
        (a.legendItem = r =
          d
            .text(
              e.labelFormat ? Fa(e.labelFormat, a) : e.labelFormatter.call(a),
              m ? g + h : -h,
              b.baseline,
              y
            )
  ...
  /Trident\/7\.0/.test(ra) &&
    Va(zb.prototype, "positionItem", function (a, b) {
      var c = this,
        d = function () {
  ...
  fb.prototype = {
    ...
    layOutTitles: function () {
      ...
      c &&
        ...
        !d.floating && !d.verticalAlign && (a = Ha(a + c.getBBox().height)));
      this.titleOffset = a;
    },
    getChartSize: function () {
      ...
      this.chartHeight = s(
        0,
        n(a.height, this.containerHeight > 19 ? this.containerHeight : 400)
      );
    },
    ...
    drawChartBox: function () {
      ...
      if (i || j)
        if (e) e.animate(e.crisp(null, null, null, c - q, d - q));
          ...
          this.chartBackground = b
            .rect(q / 2, q / 2, c - q, d - q, a.borderRadius, i)
            .attr(e)
            .add()
            .shadow(a.shadow);
        }
      ...
      t
        ? t.animate({ width: w.width, height: w.height })
        : (this.clipRect = b.clipRect(w));
      if (m)
        g
          ? g.animate(g.crisp(null, o, n, p, s))
          : (this.plotBorder = b
              .rect(o, n, p, s, 0, -m)
    ...
    isReadyToRender: function () {
      var a = this;
      return (!V && C == C.top && y.readyState !== "complete") ||
        (da && !C.canvg)
        ? (da
            ? Mb.push(function () {
                a.firstRender();
  ...
  Ja.prototype = {
    ...
    setState: function (a, b) {
      ...
      if (
        ...
        if (this.graphic)
          (f = g && this.graphic.symbolName && q[a].r),
            this.graphic.attr(
              x(
                q[a],
                f ? { x: c - f, y: d - f, width: 2 * f, height: 2 * f } : {}
              )
            );
        else {
          if (a && i)
  ...
  O.prototype = {
      ...
      if (j && k > j) {
        ...
        for (j = 0; j < k; j++)
          if (
            a[j] !== u &&
            ((e = { series: c }),
            c.pointClass.prototype.applyOptions.apply(e, [a[j]]),
            c.updateParallelArrays(e, j),
            i && e.name)
          )
            h.names[e.x] = e.name;
      fa(m[0]) && ka(14, !0);
      ...
      for (m = 0; m < g; m++)
        (i = h + m),
          j
            ...
            : (b[i]
                ? (k = b[i])
                : a[i] !== u && (b[i] = k = new f().init(this, a[i], d[m])),
              (l[m] = k));
      if (b && (g !== (c = b.length) || j))
        for (m = 0; m < c; m++)
          if ((m === h && !j && (m += g), b[m]))
    ...
    setStackedPoints: function () {
      if (
        ...
        for (n = 0; n < d; n++) {
          ...
          if (!l[o][p])
            m[o] && m[o][p]
              ? ((l[o][p] = m[o][p]), (l[o][p].total = null))
              : (l[o][p] = new Gb(k, k.options.stackLabels, q, p, g, e));
          o = l[o][p];
          ...
          e === "percent"
            ? ((q = q ? h : i),
              j && l[q] && l[q][p]
                ? ((q = l[q][p]),
                  (o.total = q.total = s(q.total, o.total) + M(r) || 0))
                : (o.total = aa(o.total + (M(r) || 0))))
            : (o.total = aa(o.total + (r || 0)));
          o.cum = (o.cum || 0) + (r || 0);
    ...
    tooltipHeaderFormatter: function (a) {
      ...
      f &&
        d &&
        wa(a.key) &&
        (b = b.replace("{point.key}", "{point.key:" + d + "}"));
      ...
      if (l.enabled || this._hasPointMarkers)
        for (f = b.length; f--; )
          if (
            ...
            (k = g.graphic),
            (i = g.marker || {}),
            (a = (l.enabled && i.enabled === u) || i.enabled),
            (m = c.isInsidePlot(w(d), e, c.inverted)),
            a && e !== u && !isNaN(e) && g.y !== null)
          )
            if (
              ((a = g.pointAttr[g.selected ? "select" : ""]),
              (h = a.r),
              (i = n(i.symbol, this.symbol)),
              (j = i.indexOf("url") === 0),
              k)
            )
              k.attr({
        ...
        f
          ...
          : (a[e] = a.chart.renderer
              ...
              .attr({
                fill: n(
                  d[2],
                  ta(d[1]).setOpacity(n(c.fillOpacity, 0.75)).get()
                ),
                zIndex: 0,
              })
              .add(a.group));
    ...
    drawPoints: function () {
      ...
      p(a.points, function (g) {
        ...
        if (h !== u && !isNaN(h) && g.y !== null)
          (f = g.shapeArgs),
            i
              ? (Za(i), i[b.pointCount < e ? "animate" : "attr"](x(f)))
              : (g.graphic = d[g.shapeType](f)
                  .attr(g.pointAttr[g.selected ? "select" : ""])
                  .add(a.group)
  ...
  W = {
    ...
    translate: function (a) {
      ...
      var b = 0,
        ...
        i =
          (this.endAngleRad = (Aa / 180) * ((c.endAngle || i + 360) - 90)) - j,
        k = this.points,
        ...
        p(b, function (b) {
          ...
          if (k && !j) b.dataLabel = k.destroy();
            ...
            if (k)
              ...
              k = b.dataLabel = a.chart.renderer[j ? "text" : "label"](
                g,
                0,
                -999,
                null,
  ...
  O.prototype.alignDataLabel = function (a, b, c, d, e) {
    ...
    if (
      (a =
        this.visible &&
        (a.series.forceDL || f.isInsidePlot(a.plotX, a.plotY, g)))
    )
      (d = r(
        {
          x: g ? f.plotWidth - i : h,
  ...
  if (L.pie)
    (L.pie.prototype.drawDataLabels = function () {
      ...
      if (a.visible && (e.enabled || a._hasPointLabels)) {
        ...
        for (K = 0; !x && b[K]; )
          (x =
            b[K] && b[K].dataLabel && (b[K].dataLabel.getBBox().height || 21)),
            K++;
        for (K = 2; K--; ) {
          var b = [],
            J = [],
          ...
          for (B = 0; B < G; B++) {
            ...
            if (l > 0) {
              if (
                ...
                (C = u.i),
                (A = u.y),
                (c > A && b[C + 1] !== null) || (c < A && b[C - 1] !== null))
              )
                A = c;
            } else A = c;
            z = e.justify
              ? m[0] + (K ? -1 : 1) * (q + l)
              : a.getX(C === 0 || C === b.length - 1 ? c : A, K);
            ...
            if (this.options.size === null)
              (u = t.width),
                z - u < f
                  ? (D[3] = s(w(u - z + f), D[3]))
                  : z + u > h - f && (D[1] = s(w(z + u - h + f), D[1])),
                A - x / 2 < 0
                  ? (D[0] = s(w(-A + x / 2), D[0]))
                  : A + x / 2 > d && (D[2] = s(w(A + x / 2 - d), D[2]));
          }
        }
      ...
      (L.pie.prototype.alignDataLabel = la),
